...
import com.nasa.explorer.service.NasaService; // Importando a implementação concreta
...
public class NasaController {
    ...
    @Autowired
    private NasaService nasaService; // Alterado para a implementação concreta
